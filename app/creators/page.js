                        ...
                        <div className={styles.right}>
                            <div className={styles.text}>
                                ...
                                <p className={styles.about}>
                                    طراح سایت تازه کار آماده ام که به بهترین روش از این علاقه ی خودم یعنی طراحی سایت به بهترین روش در پیشرفت خودم استفاده کنم.
                                    من یک طراح سایت علاقه به یادگیری مباحثی چون امنیت شبکه برنامه نویسی هوش مصنوعی و.. هستم 
                                    من در تهران به دنیا آمدم و از 15 سالگی شروع به برنامه نویسی و طراحی وب کردم 
