                        ...
                        <div className={styles.grid}>
                            <div className={styles.left}>
                                ...
                                <p className={styles.picText}>
                                    ...
                                    <p>
                                        - کلاس‌های حرفه‌ای برای کسب مهارت‌های ارتباطی و ظرفیت‌سنجی
                                        - مشارکت در مجموعه فرهنگی و دانش‌آموزی خیبریون
                                        - تدریس به عنوان دبیر دروس عربی، جامعه‌شناسی، تاریخ و ... با بیش از 15 سال سابقه تدریس
                                    </p><br/>
                                    <h3>
