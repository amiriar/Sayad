                        ...
                        <div className={styles.grid}>
                            <div className={styles.left}>
                                ...
                                <p className={styles.picText}>
                                    ...
                                    <br/>
                                    <h4>
                                        فردی همواره موفق و با تحصیلات گسترده در رشته‌های مختلف مانند:
                                    </h4>
                                    <p>
                                        - جامعه‌شناسی <br/>
                                        - علوم حدیث (گرایش به نهج البلاغه) <br/>
                                        - مدیریت برنامه‌ریزی <br/>
                                    </p>
                                    <br/>
                                    <h4>
                                        حضور فعّال ایشان در صحنه‌های متنوع از جمله:
                                    </h4>
                                    <p>
                                        - کلاس‌های حرفه‌ای برای کسب مهارت‌های ارتباطی و ظرفیت‌سنجی <br/>
                                        - مشارکت در مجموعه فرهنگی و دانش‌آموزی خیبریون <br/>
                                        - تدریس به عنوان دبیر دروس عربی، جامعه‌شناسی، تاریخ و ... با بیش از 15 سال سابقه تدریس <br/>
                                    </p><br/>
                                    <h3>
                                        و در نهایت؛ "مدیریت هنرستان شهید صیاد شیرازی" با افتخار به عهده ایشان است.
                                    </h3>
                                </p>
                                <p className={styles.picText2}>
                                </p>
